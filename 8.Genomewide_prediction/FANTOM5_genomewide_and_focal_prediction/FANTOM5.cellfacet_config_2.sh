...
DESIGN_MATRIX="FANTOM5.cellfacet_design_matrix_2.tsv"
OUTPUT_DIR="FANTOM5.cellfacet_2"
CTSS_RSE_NAME="ctss_rse_FANTOM5.cellfacet.pooled.bw_2.rds"

### 0 ### _0_validate_ctss_and_region.r
CTSS_RSE_RDS="/FANTOM5.cellfacet_2/ctss_rse_FANTOM5.cellfacet.pooled.bw_2.rds"
